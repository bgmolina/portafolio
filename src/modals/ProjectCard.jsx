      ...
      {showModal && (
        ...
        >
          ...
          <motion.section
            ...
            className="flex w-full flex-col gap-5 rounded-t-xl bg-sidebar pb-20 text-white md:max-w-3xl md:rounded-b-xl md:pt-5 md:pb-5"
          >
            {/* button close modal */}
            <button
              onClick={onClickShowModal}
